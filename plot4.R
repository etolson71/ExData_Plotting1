...
#Plot for top left
plot(elect1$datetm,elect1$Global_active_power,type="l",xlab="",ylab="Global Active Power",cex.axis=0.8,cex.lab=0.8)

#Plot for top right
plot(elect1$datetm,elect1$Voltage,type="l",ylab="Voltage",xlab="datetime",cex.axis=0.8,cex.lab=0.8)

#Plot for bottom left
plot(elect1$datetm,elect1$Sub_metering_1,type="n",col="black",ylim=c(0,37),xlab="",ylab="Energy sub metering",cex.axis=0.8,cex.lab=0.8)
...
plot(elect1$datetm,elect1$Global_reactive_power,type="l",ylim=c(0,0.5),cex.axis=0.8,cex.lab=0.8,ylab="Global_reactive_power",xlab="datetime")
